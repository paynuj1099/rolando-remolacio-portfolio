...
const projects = [
    ...
    description: 'Premium golf ecommerce brand website with a minimalist design, aspirational branding. Built for performance and modern aesthetic.',
  ...
  },
   {
    ...
    description: 'Website auditor tool that analyzes websites for search engine optimization, providing insights and recommendations for improvement.',
